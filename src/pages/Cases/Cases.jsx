...
export const casesData = [
  ...
  },
  {
    ...
    price: 2500,
    little_description:
      "Разработка финансового приложения с расширенными функциями!",
    steps:
      "На ранних этапах сотрудничества, мы составили поэтапную смету, промежуточные сроки реалиазции,\n" +
      "в рамках которых, вели дальнейшую разработку проекта.",
  },
  {
    ...
    price: 500,
    little_description:
      "Создание образовательного контента для школ и университетов.",
    steps:
      "На ранних этапах сотрудничества, мы составили поэтапную смету, промежуточные сроки реалиазции,\n" +
      "в рамках которых, вели дальнейшую разработку проекта.",
  },
  {
    ...
    price: 1500,
    little_description:
      "Маркетинговая кампания для увеличения продаж в розничной торговле!",
    steps:
      "На ранних этапах сотрудничества, мы составили поэтапную смету, промежуточные сроки реалиазции,\n" +
      "в рамках которых, вели дальнейшую разработку проекта.",
  },
  {
    ...
    price: 3000,
    little_description:
      "Брендинг для медиа-компании, включая разработку логотипа и стиля.",
    steps:
      "На ранних этапах сотрудничества, мы составили поэтапную смету, промежуточные сроки реалиазции,\n" +
      "в рамках которых, вели дальнейшую разработку проекта.",
  },
  {
    ...
    price: 800,
    little_description:
      "Аналитика для технологической компании с фокусом на улучшение KPI.",
    steps:
      "На ранних этапах сотрудничества, мы составили поэтапную смету, промежуточные сроки реалиазции,\n" +
      "в рамках которых, вели дальнейшую разработку проекта.",
  },
