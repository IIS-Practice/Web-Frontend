...
const Contacts = () => {
  ...
  return (
    <div className="contacts-page">
      ...
      <div>
        <h1 className="contact-head">Мы рады увидеть <span className="form-head">Вашу</span> заявку!</h1>
        <p className="contact-p">Пожалуйста оставьте Ваши имя и телефон, мы будем счастливы помочь Вам.</p>
