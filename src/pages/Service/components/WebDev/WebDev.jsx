    ...
    <div className={styles.container}>
      <div className={styles.headingContainer}>
        <h1 className={styles.heading}>
          Создавая <span className={styles.headingSpan}>уникальные сайты</span>, мы воплощаем в жизнь коммерческие цели наших клиентов
        </h1>
      </div>
        ...
        <div className={styles.content}>
          ...
          <div className={styles.pointsAndDescription}>
            ...
            <div className={styles.pointDescription}>
              <h3 className={styles.descriptionHeading}>{currentMistake.heading}</h3>
              <p className={styles.mistakeDescription}>{currentMistake.description}</p>
      ...
      <div className={styles.advContainer}>
        <div className={styles.content}>
          <div>
            <h3 className={styles.advHeading}>Почему работать с нами удобно и выгодно?</h3>
            <div className={styles.advContent}>
              <div className={styles.advElement}>
                <div className={styles.advElementHeadingContainer}>
                  <h3 className={styles.advElementHeading}>ПРОЕКТИРОВАНИЕ ИНТЕРФЕЙСОВ</h3>
                </div>
              ...
              <div className={styles.advElement}>
                <div className={styles.advElementHeadingContainer}>
                  <h3 className={styles.advElementHeading}>ПРОГРАММИРОВАНИЕ И ИНТЕГРАЦИЯ</h3>
                </div>
                <p className={styles.advDescription}>
              ...
              <div className={styles.advElement}>
                <div className={styles.advElementHeadingContainer}>
                  <h3 className={styles.advElementHeading}>ПОИСКОВАЯ ОПТИМИЗАЦИЯ</h3>
                </div>
                <p className={styles.advDescription}>
        ...
        <div className={styles.content}>
          ...
          <div className={styles.getPointsContainer}>
            <div className={styles.getPointsElement}>
              ...
              <h4 className={styles.pointsElementHeading}>Гарантии и уверенность</h4>
            ...
            <div className={styles.getPointsElement}>
              ...
              <h4 className={styles.pointsElementHeading}>Контроль и отчетность</h4>
              <h4 className={styles.pointsElementDescription}>
            ...
            <div className={styles.getPointsElement}>
              ...
              <h4 className={styles.pointsElementHeading}>Обучение и поддержка</h4>
              <h4 className={styles.pointsElementDescription}>
