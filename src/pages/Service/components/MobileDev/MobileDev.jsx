  ...
  return (
    <div className={styles.container}>
      ...
      <p className={styles.topLevelText}>
        Мы разрабатываем iOS и Android приложения, отвечающие всем требованиям и
        рекомендациям этих платформ, и обеспечиваем их стабильную работу, чтобы
        охватить максимальное количество пользователей.
      </p>
      <p className={styles.topLevelText}>
        Сочетая творчество и технологии, наша компания способна создать удобный
        и простой в использовании проект, решающий сложные бизнес-задачи.
      </p>
      <div className={styles.stagesContainer}>
        <div className={styles.content}>
          <h3 className={styles.stagesHeading}>Этапы разработки приложения</h3>
