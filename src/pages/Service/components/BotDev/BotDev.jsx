  ...
  return (
    <div className={styles.container}>
      ...
      <p className={styles.topLevelText}>
        Мы поможем существенно улучшить ваши бизнес-процессы и взаимодействие с
        клиентами.
      </p>
      ...
      <div className={styles.stagesContainer}>
        <div className={styles.content}>
          <h3 className={styles.stagesHeading}>Как мы это делаем?</h3>
      ...
      <div className={`${styles.applicationContainer} ${styles.content}`}>
        <h3 className={styles.applicationHeading}>
          Свяжитесь с нами, чтобы обсудить возможности разработки ботов для
          вашего бизнеса.
        </h3>
